document.getElementById('exportJSONUsersButton').addEventListener('click',  exportUsers);

const addUsersForm = document.getElementById('addUsersForm');
addUsersForm.addEventListener("submit",  addUsers);

const editForm = document.getElementById('editUsersForm');
...
const addModal = document.getElementById("addUsersPopup");
const openAddUsersButton = document.getElementById("openAddUsersPopupButton");
const closeAddUsersPopupButton = document.getElementById("closeAddUsersPopupButton");
...
function openEditModal() {
    const editModal = document.getElementById("editUsersPopup");
    ...
    const closeEditUsersPopupButton = document.getElementById("closeEditUsersPopupButton");
    closeEditUsersPopupButton.addEventListener('click', closeModal);

    const editModalBackdrop = document.getElementById("editUsersPopup");
...
function createSaveButton() {
    ...
    saveButton.setAttribute('id', 'editUsersButton');
...
function openDeleteModal(username, tableName) {
    const deleteModal = document.getElementById("deleteUsersPopup");
    deleteModal.style.display = "block";

    const deleteModalForm = document.getElementById("deleteUsersForm");
    ...
    const closeDeleteUsersPopupButton = document.getElementById("closeDeleteUsersPopupButton");
    closeDeleteUsersPopupButton.addEventListener('click', () => {
        closeModal();
    });

    const deleteModalBackdrop = document.getElementById("deleteUsersPopup");
...
async function handleDeleteButtonClick(username, tableName) {
    ...
    const popup = document.getElementById('deleteUsersPopup');
...
function createTooltipContent(data, username) {
    ...
    content += `
        <div class="tooltip__controls">
            <button class="tooltip__controls-edit" data-username="${username}" id="openEditUsersPopupButton">
            ...
            <button class="tooltip__controls-remove" data-username="${username}" id="openDeleteUsersPopupButton">
    ...
    if (tooltip && tooltip.classList.contains('tooltip')) {
        ...
        fetchAdditionalData(username)
            .then(response => {
                ...
                const editButton = document.getElementById('openEditUsersPopupButton');
                editButton.addEventListener('click', () => handleEditButtonClick(username, tableName));

                const deleteButton = document.getElementById('openDeleteUsersPopupButton');
